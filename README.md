...
- Потом напишу нормальное описание.
- Домен для фронтенда: `evgni.nomoredomains.work`.
- Домен для бэкенда: `evgni.diploma.nomoredomains.rocks` _(зазевалась и, думая, что регистрирую домен для фронта, зарегистрировала его для бэка =( потому и без `api.` )_.
